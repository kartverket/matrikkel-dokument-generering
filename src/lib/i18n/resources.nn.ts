  ...
  rapport: {
    ...
    BYG0011: {
      ...
      bruksenheter: {
        ...
        ingenTiltakshavere: "Ingen tiltakshavarar registrerte.",
        ingenHjemmelshavere: "Ingen heimelshavarar registrerte.",
        ingenKontaktpersoner: "Ingen kontaktpersonar registrerte.",
        endring: "Endring",
        endringKort: "Endring {{lopenr}}",
        gjeldende: "Gjeldande",
